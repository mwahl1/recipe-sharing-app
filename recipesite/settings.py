...
SECRET_KEY = 'django-insecure-lgcs6bo599p%vh3c9d2bu&ivu%t5i9=6(&m&3^t*#gn7e9!*b9'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',  # Correctly separated with a comma
    'recipes',                     # Correctly separated with a comma
    'crispy_forms',               # Already has a comma
]
